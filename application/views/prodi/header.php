        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$this->session->nama_user?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                <a href="<?=base_url()?>prodi/settings/<?=$this->encrypt->encode($this->uri->uri_string())?>" class="btn btn-default btn-flat btn-sm">Settings</a>
                </div>
                <div class="pull-right">
                  <!-- <a href="<?=base_url()?>login/logout/prodi" class="btn btn-default btn-flat btn-sm">Log out</a> -->
